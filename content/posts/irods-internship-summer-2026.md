...
iRODS 5 has recently added a new 'irods' authentication scheme.  This functionality needs 
to be made available in our existing clients and client libraries.
